...
echo "prompt: Use the pr-description skill to write the PR description for this branch against main. Do not open a PR, just output the markdown."; echo "trigger: Write the PR description for this branch against main. Do not open a PR, just output the markdown."
