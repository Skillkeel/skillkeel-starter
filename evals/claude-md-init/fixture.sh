...
gi add -A; gi commit -qm "chore: init"; echo "prompt: Use the claude-md-init skill to create CLAUDE.md for this repo. Write the file."; echo "trigger: This repo has no CLAUDE.md. Create one for Claude Code and write the file."
