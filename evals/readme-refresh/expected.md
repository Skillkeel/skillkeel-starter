...
3. Dead link handled: removed, replaced with existing target, or marked `<!-- TODO: verify -->`; not left as a false claim.
4. "A tiny service." and License section untouched.
