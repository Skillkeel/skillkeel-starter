...
echo "prompt: Use the secret-audit skill on this repo. Do not rewrite history."; echo "trigger: Were any secrets ever committed to this repo? Check the history too. Do not rewrite history."
